...
?>
			...
			<footer role="contentinfo" class="uxr-footer uxr-layout-full_row">
				<div class="uxr-footer_inside">
					<div class="uxr-grid-container">
						...
						<div class="uxr-footer_more">
							...
							<p>Quelque chose à nous dire ? <a href="mailto:<?php echo antispambot('collectif@uxrennes.co'); ?>">Contactez-nous !</a></p>
						</div>
					</div>
				</div>
			</footer>
